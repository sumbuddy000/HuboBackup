...
if("TRUE" STREQUAL "TRUE")
  set(rviz_visual_tools_SOURCE_PREFIX /home/jessparr/ws_moveit/src/rviz_visual_tools)
  set(rviz_visual_tools_DEVEL_PREFIX /home/jessparr/ws_moveit/devel/.private/rviz_visual_tools)
  ...
  set(rviz_visual_tools_INSTALL_PREFIX /home/jessparr/ws_moveit/install)
...
if(NOT "/home/jessparr/ws_moveit/src/rviz_visual_tools/include;/usr/include/OGRE " STREQUAL " ")
  set(rviz_visual_tools_INCLUDE_DIRS "")
  set(_include_dirs "/home/jessparr/ws_moveit/src/rviz_visual_tools/include;/usr/include/OGRE")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_visual_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jessparr/ws_moveit/src/rviz_visual_tools/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jessparr/ws_moveit/devel/.private/rviz_visual_tools/lib;/home/jessparr/ws_moveit/devel/lib;/opt/ros/melodic/lib)
...
set(depends "geometry_msgs;graph_msgs;shape_msgs;roscpp;sensor_msgs;std_msgs;tf2_eigen;tf2_ros;trajectory_msgs;visualization_msgs")
