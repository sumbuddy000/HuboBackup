  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v54.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v54.db = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v130.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v136.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v136.db = str[start:end].decode('utf-8')
        else:
