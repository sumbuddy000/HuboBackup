...
class MoveGroupSequenceGoal(genpy.Message):
  _md5sum = "ba8d1f5fabb8eeb4328bbc7b2770aaa0"
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v180.position = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v180.velocity = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v180.effort = struct.unpack(pattern, str[start:end])
        ...
        for i in range(0, length):
          ...
          if python3:
            _v192.id = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v198.key = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v198.db = str[start:end].decode('utf-8')
          else:
        ...
        if python3:
          _v234.name = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v173.planner_id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v173.group_name = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v307.frame_id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v306.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v312.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v312.db = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v336.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v336.db = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v528.frame_id = str[start:end].decode('utf-8')
        else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v537.frame_id = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v536.id = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v542.key = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v542.db = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v552.frame_id = str[start:end].decode('utf-8')
          else:
        ...
        for i in range(0, length):
          ...
          for i in range(0, length):
            ...
            if python3:
              _v563.frame_id = str[start:end].decode('utf-8')
            else:
          ...
          for i in range(0, length):
            ...
            if python3:
              _v567.frame_id = str[start:end].decode('utf-8')
            else:
        ...
        if python3:
          _v578.name = str[start:end].decode('utf-8')
        else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v579.frame_id = str[start:end].decode('utf-8')
          else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v591.frame_id = str[start:end].decode('utf-8')
          else:
        ...
        for i in range(0, length):
          ...
          for i in range(0, length):
            ...
            if python3:
              _v611.frame_id = str[start:end].decode('utf-8')
            else:
          ...
          for i in range(0, length):
            ...
            if python3:
              _v615.frame_id = str[start:end].decode('utf-8')
            else:
            ...
            if python3:
              _v621.frame_id = str[start:end].decode('utf-8')
            else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v626.frame_id = str[start:end].decode('utf-8')
          else:
          ...
          for i in range(0, length):
            ...
            if python3:
              _v628.frame_id = str[start:end].decode('utf-8')
            else:
          ...
          for i in range(0, length):
            ...
            if python3:
              _v631.frame_id = str[start:end].decode('utf-8')
            else:
        ...
        if python3:
          _v517.planner_id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v517.group_name = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v651.frame_id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v650.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v656.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v656.db = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v666.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v680.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v680.db = str[start:end].decode('utf-8')
        else:
