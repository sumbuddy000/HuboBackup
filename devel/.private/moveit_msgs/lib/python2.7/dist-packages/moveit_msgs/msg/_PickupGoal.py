  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v156.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v162.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v162.db = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v186.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v186.db = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v350.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v366.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v369.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v380.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v380.db = str[start:end].decode('utf-8')
        else:
