...
class MotionSequenceItem(genpy.Message):
  _md5sum = "3c767629e5afe06a59e67603eb6c6112"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.req.start_state.joint_state.position))
      length = len(self.req.start_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.req.start_state.joint_state.velocity))
      length = len(self.req.start_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.req.start_state.joint_state.effort))
      _x = self
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_i4d().pack(_x.req.num_planning_attempts, _x.req.allowed_planning_time, _x.req.max_velocity_scaling_factor, _x.req.max_acceleration_scaling_factor, _x.blend_radius))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.req.workspace_parameters.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.req.start_state.joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.req.start_state.joint_state.position = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.req.start_state.joint_state.velocity = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.req.start_state.joint_state.effort = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.req.start_state.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v119.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v125.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v125.db = str[start:end].decode('utf-8')
        else:
      ...
      if python3:
        self.req.path_constraints.name = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.req.planner_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.req.group_name = str[start:end].decode('utf-8')
      else:
        self.req.group_name = str[start:end]
      _x = self
      start = end
      end += 36
      (_x.req.num_planning_attempts, _x.req.allowed_planning_time, _x.req.max_velocity_scaling_factor, _x.req.max_acceleration_scaling_factor, _x.blend_radius,) = _get_struct_i4d().unpack(str[start:end])
      return self
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v343.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v349.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v349.db = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            _v426.frame_id = str[start:end].decode('utf-8')
          else:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            _v433.frame_id = str[start:end].decode('utf-8')
          else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v436.frame_id = str[start:end].decode('utf-8')
          else:
