  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v197.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v203.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v203.db = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v227.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v227.db = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v242.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v248.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v248.db = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v441.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v479.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v479.db = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v524.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v524.db = str[start:end].decode('utf-8')
        else:
