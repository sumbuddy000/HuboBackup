...
class MoveGroupGoal(genpy.Message):
  _md5sum = "061b60020fe67647a211d40e497e91f7"
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v164.id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v276.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v282.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v282.db = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v478.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v484.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v484.db = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v494.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            _v497.frame_id = str[start:end].decode('utf-8')
          else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v505.frame_id = str[start:end].decode('utf-8')
          else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v515.frame_id = str[start:end].decode('utf-8')
          else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v520.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            _v543.frame_id = str[start:end].decode('utf-8')
          else:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            _v571.frame_id = str[start:end].decode('utf-8')
          else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v590.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v596.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v596.db = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v606.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v609.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v620.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v620.db = str[start:end].decode('utf-8')
        else:
