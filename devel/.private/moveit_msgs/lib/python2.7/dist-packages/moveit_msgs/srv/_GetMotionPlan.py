...
class GetMotionPlanRequest(genpy.Message):
  _md5sum = "e674e13eb07172ca8fe12e15777d8e54"
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v488.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v494.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v494.db = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v504.frame_id = str[start:end].decode('utf-8')
        else:
...
class GetMotionPlan(object):
  ...
  _md5sum = 'a8ddcf38f27fad62f9c0daba937a452b'
