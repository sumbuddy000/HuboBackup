  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v60.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v66.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v66.db = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v166.id = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v244.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v250.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v250.db = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v294.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v300.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v300.db = str[start:end].decode('utf-8')
        else:
