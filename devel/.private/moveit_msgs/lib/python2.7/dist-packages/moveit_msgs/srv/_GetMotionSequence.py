...
class GetMotionSequenceRequest(genpy.Message):
  _md5sum = "90a61c59594bc87bbdf204b45c27cb17"
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v135.position = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v135.velocity = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v135.effort = struct.unpack(pattern, str[start:end])
        ...
        for i in range(0, length):
          ...
          if python3:
            _v147.id = str[start:end].decode('utf-8')
          else:
        ...
        if python3:
          _v189.name = str[start:end].decode('utf-8')
        else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v198.frame_id = str[start:end].decode('utf-8')
          else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v208.frame_id = str[start:end].decode('utf-8')
          else:
        ...
        if python3:
          _v128.planner_id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v128.group_name = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v384.frame_id = str[start:end].decode('utf-8')
        else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v401.id = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v407.key = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v407.db = str[start:end].decode('utf-8')
          else:
        ...
        for i in range(0, length):
          ...
          for i in range(0, length):
            ...
            if python3:
              _v432.frame_id = str[start:end].decode('utf-8')
            else:
            ...
            if python3:
              _v438.frame_id = str[start:end].decode('utf-8')
            else:
        ...
        if python3:
          _v443.name = str[start:end].decode('utf-8')
        else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v444.frame_id = str[start:end].decode('utf-8')
          else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v456.frame_id = str[start:end].decode('utf-8')
          else:
        ...
        for i in range(0, length):
          ...
          for i in range(0, length):
            ...
            if python3:
              _v480.frame_id = str[start:end].decode('utf-8')
            else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v491.frame_id = str[start:end].decode('utf-8')
          else:
          ...
          for i in range(0, length):
            ...
            if python3:
              _v496.frame_id = str[start:end].decode('utf-8')
            else:
        ...
        if python3:
          _v382.planner_id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v382.group_name = str[start:end].decode('utf-8')
        else:
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.response.sequence_start.joint_state.position))
      length = len(self.response.sequence_start.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.response.sequence_start.joint_state.velocity))
      length = len(self.response.sequence_start.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.response.sequence_start.joint_state.effort))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.response.sequence_start.joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.response.sequence_start.joint_state.position = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.response.sequence_start.joint_state.velocity = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.response.sequence_start.joint_state.effort = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.response.sequence_start.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v554.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v560.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v560.db = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v570.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v574.frame_id = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v633.frame_id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v632.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v638.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v638.db = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v648.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v656.frame_id = str[start:end].decode('utf-8')
        else:
...
class GetMotionSequence(object):
  ...
  _md5sum = '103a0580f54cf00c8ac0d29ddfdabd93'
