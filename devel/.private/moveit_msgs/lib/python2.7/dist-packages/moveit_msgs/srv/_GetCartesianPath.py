...
class GetCartesianPathRequest(genpy.Message):
  _md5sum = "7577545fe2cc8d9cc95386091a2b895c"
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v63.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v63.db = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v163.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v163.db = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v240.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v246.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v246.db = str[start:end].decode('utf-8')
        else:
...
class GetCartesianPath(object):
  ...
  _md5sum = '233252ac24beb08ddd3d972d38a9e17d'
