...
struct MD5Sum< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> >
{
  ...
  {
    return "0af710ae4b311328ce15a8ef08d4035d";
  }

  static const char* value(const ::moveit_msgs::MoveGroupAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x0af710ae4b311328ULL;
  static const uint64_t static_value2 = 0xce15a8ef08d4035dULL;
};
