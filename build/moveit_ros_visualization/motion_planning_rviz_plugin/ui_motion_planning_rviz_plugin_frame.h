...
public:
    ...
    void setupUi(QWidget *MotionPlanningUI)
    {
        ...
        gridLayout_4->addWidget(pose_scale_group_box, 0, 1, 1, 1);
        ...
        object_status->setTextInteractionFlags(Qt::TextBrowserInteraction);

        verticalLayout_12->addWidget(object_status);


        gridLayout_4->addWidget(groupBox_5, 1, 1, 1, 1);
    ...
    void retranslateUi(QWidget *MotionPlanningUI)
    {
        ...
        pose_scale_group_box->setTitle(QApplication::translate("MotionPlanningUI", "Change Object Pose and Scale", Q_NULLPTR));
